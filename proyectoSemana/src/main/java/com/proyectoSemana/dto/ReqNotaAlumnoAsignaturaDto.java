...
public class ReqNotaAlumnoAsignaturaDto {
    ...
    public double getPromedioNotasDto() {
        return promedioNotasDto;
    }

    public void setPromedioNotasDto(double promedioNotasDto) {
        this.promedioNotasDto = promedioNotasDto;
    }

    public double getPromedioControlesDto() {
        return promedioControlesDto;
    }

    public void setPromedioControlesDto(double promedioControlesDto) {
